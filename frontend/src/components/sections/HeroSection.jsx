...
export default function HeroSection() {
  return (
    <section className="relative h-[500px] flex items-center overflow-hidden">
      ...
      <div className="relative z-20 max-w-[1280px] mx-auto px-6 w-full pb-32">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl text-white mb-4 max-w-[48rem] leading-tight font-bold text-balance animate-fade-in-up" style={{ animationDelay: '100ms' }}>
