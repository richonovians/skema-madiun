  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      ...
      <button
        ...
        className="flex items-center gap-2 p-1 rounded-full hover:bg-surface-container-low transition-all focus:outline-none focus:ring-2 focus:ring-primary"
        ...
        <div className="absolute right-0 mt-2 w-64 origin-top-right rounded-2xl bg-surface p-2 shadow-xl shadow-slate-900/10 border border-border/80 focus:outline-none z-50 animate-in fade-in zoom-in-95 duration-200">
          ...
          <div className="border-t border-border/60 my-1 pt-1">
            <button
              ...
              className="w-full flex items-center gap-3 px-3.5 py-2.5 text-sm font-semibold text-red-600 rounded-xl hover:bg-red-50 dark:hover:bg-red-950/30 transition-colors text-left"
            >
