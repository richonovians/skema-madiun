...
export default function StatisticsHero() {
  return (
    <section className="bg-surface-container-low pt-24 pb-20 px-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-4xl mx-auto relative z-10">
        ...
        {/* Heading */}
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-text-primary leading-tight tracking-tight mb-6 text-center">
