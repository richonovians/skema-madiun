...
export default function TopOpdRanking({ data }) {
  return (
    <div className="bg-white rounded-2xl p-4 sm:p-6 md:p-8 border border-border shadow-sm flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col gap-4">
        {data.map((opd, idx) => (
          <div key={idx} className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl bg-surface-container-low hover:bg-surface-container transition-colors group border border-transparent hover:border-outline-variant/30">
            {/* Rank / Medal */}
