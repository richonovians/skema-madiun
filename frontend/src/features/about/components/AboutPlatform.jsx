  ...
  return (
    <section className="py-24 bg-background relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-stretch animate-fade-in-up" style={{ animationDelay: '100ms' }}>
          {/* Background Card */}
          <div className="group relative p-8 md:p-10 rounded-3xl bg-white border border-slate-200 shadow-sm hover:shadow-xl hover:shadow-primary/5 transition-all duration-300 overflow-hidden flex flex-col justify-center">
          ...
          {/* Purpose Card */}
          <div className="group relative p-8 md:p-10 rounded-3xl bg-gradient-to-br from-slate-900 to-slate-800 text-white shadow-xl shadow-slate-900/10 transition-all duration-300 overflow-hidden flex flex-col justify-center">
