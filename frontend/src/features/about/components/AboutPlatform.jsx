    ...
    <section className="py-16 sm:py-24 bg-background relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-12 items-stretch animate-fade-in-up" style={{ animationDelay: '100ms' }}>
          {/* Background Card */}
          <div className="group relative p-6 sm:p-8 md:p-10 rounded-3xl bg-white border border-slate-200 shadow-sm hover:shadow-xl hover:shadow-primary/10 hover:-translate-y-2 transition-all duration-300 overflow-hidden flex flex-col justify-center">
          ...
          {/* Purpose Card */}
          <div className="group relative p-6 sm:p-8 md:p-10 rounded-3xl bg-gradient-to-br from-slate-900 to-slate-800 text-white shadow-xl shadow-slate-900/10 hover:shadow-2xl hover:shadow-primary/20 hover:-translate-y-2 transition-all duration-300 overflow-hidden flex flex-col justify-center">
            ...
            <div className="relative z-10">
              <div className="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center text-blue-300 mb-6 backdrop-blur-sm border border-white/10 group-hover:bg-blue-500 group-hover:text-white group-hover:border-blue-400 transition-colors duration-300">
                <Target size={24} />
              </div>
